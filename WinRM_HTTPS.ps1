...
# 3. Desactivar la autenticación básica (solo NTLM o Kerberos permitidos)
Write-Host "Desactivando autenticación básica en WinRM..."
winrm set winrm/config/service/Auth '@{Basic="false"}'

# 4. No permitir credenciales sin cifrar
Write-Host "Desactivando credenciales sin cifrar en WinRM..."
